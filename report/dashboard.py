...
class ReportDropdown(Dropdown):   
    ...
    def build_component(self, entity_id, model):
        ...
        #### YOUR CODE HERE
            return super().build_component(entity_id, model, label=label, name=name)
...
class LineChart(MatplotlibViz):
    ...
    def build_component(self, entity_id, model):
        ...
        # ['Positive', 'Negative']
        #### YOUR CODE HERE
        df = df.rename(columns={'total_positive': 'Positive', 'total_negative': 'Negative'})
...
def BarChart(MatplotlibViz):
    ...
    def visualization(self, asset_id, model):
        ...
        #### YOUR CODE HERE
        probability = self.predictor.predict_proba(data)
